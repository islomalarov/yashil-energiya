...
export async function generateMetadata({
  ...
  return createStaticMetadata(locale, "installationRequest");
}

export default function InstallationRequestLayout({
  children,
  params,
}: {
...
async function StaticJsonLd({ params }: MetadataProps) {
  ...
  return <TheJsonLd data={staticPageJsonLd(locale, "installationRequest")} />;
}
