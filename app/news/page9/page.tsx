...
import photo1 from "@/public/newsPhoto/photo-9.jpg";
import photo2 from "@/public/newsPhoto/photo-9-1.jpg";
      ...
      <div className="newsContainer">
        <div className={styles.content}>
          <h1 style={{ textAlign: "center", paddingBottom: 50 }}>
            “Yashil Energiya”: Namangan va Farg'ona viloyatlarida quyosh
          ...
          <p>
            Namangan va Farg'ona viloyatlarida kichik quvvatli qayta tiklanuvchi
