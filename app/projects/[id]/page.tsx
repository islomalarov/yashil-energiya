    ...
    <>
      ...
      <div className="container">
        <div className={styles.content}>
          ...
          <div className={styles.addressBlcok}>
            <svg
              width="16px"
              height="16px"
              viewBox="-2 0 32 32"
          ...
          <p>
            ...
            commodi! Vero cum provident iure ad tempora autem maiores ratione ab
            sed deserunt officia totam eos id, sunt sequi laborum omnis culpa
            perspiciatis quis unde corporis commodi cupiditate, consectetur quo?
            Architecto quas libero, pariatur ullam nisi minus voluptatibus
            voluptatem officiis exercitationem magni soluta autem. Explicabo,
