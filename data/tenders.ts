export const tenders = [
  {
    ...
    tendersRu: [
      {
        id: 1,
        title: "Конкурс на закупку оргтехники",
        status: "Завершен",
        deadline: "30.05.2025",
      ...
      {
        id: 2,
        title: "Конкурс на закупку канцтоваров",
        status: "Завершен",
        deadline: "02.06.2025",
    ...
    tendersEn: [
      {
        id: 1,
        title: "Competition for the purchase of office equipment",
        status: "Completed",
        deadline: "30.05.2025",
        file: "RFQ_IT_office.docx",
      },
      {
        id: 2,
        title: "Competition for the purchase of stationery",
        status: "Completed",
        deadline: "02.06.2025",
        file: "RFQ_Invitation_eng_stationery.docx",
      },
